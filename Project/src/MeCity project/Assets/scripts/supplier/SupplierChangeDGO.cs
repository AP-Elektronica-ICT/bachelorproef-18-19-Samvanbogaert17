...
public class SupplierChangeDGO : MonoBehaviour
{
    ...
    private void BuyGreen()
    {
        ...
        float value = (float.Parse(money.text) - float.Parse(greenEnergyItems[test].getPrice().ToString()));
        money.text = string.Format("{0:n0}", value);
    ...
    private void BuyRegular()
    {
        ...
        float value = (float.Parse(money.text) - float.Parse(normalEnergyItems[test].getPrice().ToString()));
        money.text = string.Format("{0:n0}", value);
